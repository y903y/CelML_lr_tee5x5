...
int main ( int argc , char** argv ) {
  ...
  for(membrane_time = 0.000000; ( membrane_time <= 0.100000 ) ;membrane_time =  ( membrane_time + deltat ) ){
...
//      i = (double)100;
    ...
    //for(__i=6; __i<=17; __i++){
      ...
      /* test */
      sprintf( testName, "slow_inward_current_f_gate_beta_f__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_f_gate_beta_f__n[__i], diff );
      sprintf( testName, "plateau_potassium_current_Kp__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, plateau_potassium_current_Kp__n[__i], diff );
      sprintf( testName, "slow_inward_current_f_gate_alpha_f__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_f_gate_alpha_f__n[__i], diff );
      sprintf( testName, "slow_inward_current_d_gate_alpha_d__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_d_gate_alpha_d__n[__i], diff );
      sprintf( testName, "slow_inward_current_d_gate_beta_d__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_d_gate_beta_d__n[__i], diff );
      sprintf( testName, "slow_inward_current_E_si__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_E_si__n[__i], diff );
      sprintf( testName, "membrane_i_b__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, membrane_i_b__n[__i], diff );
      sprintf( testName, "fast_sodium_current_j_gate_beta_j__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_j_gate_beta_j__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_g_K__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_g_K__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_E_K__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_E_K__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_X_gate_alpha_X__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_X_gate_alpha_X__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_X_gate_beta_X__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_X_gate_beta_X__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_Xi__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_Xi__n[__i], diff );
      sprintf( testName, "time_independent_potassium_current_g_K1__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_independent_potassium_current_g_K1__n[__i], diff );
      sprintf( testName, "time_independent_potassium_current_E_K1__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_independent_potassium_current_E_K1__n[__i], diff );
      sprintf( testName, "fast_sodium_current_E_Na__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_E_Na__n[__i], diff );
      sprintf( testName, "fast_sodium_current_j_gate_alpha_j__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_j_gate_alpha_j__n[__i], diff );
      sprintf( testName, "fast_sodium_current_h_gate_alpha_h__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_h_gate_alpha_h__n[__i], diff );
      sprintf( testName, "fast_sodium_current_m_gate_beta_m__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_m_gate_beta_m__n[__i], diff );
      sprintf( testName, "fast_sodium_current_m_gate_alpha_m__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_m_gate_alpha_m__n[__i], diff );
      sprintf( testName, "fast_sodium_current_h_gate_beta_h__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_h_gate_beta_h__n[__i], diff );
    }
    //----------------------------- LOOP END -----------------------------//
    ...
    for(__i=6; __i<=17; __i++){
      ...
      sprintf( testName, "fast_sodium_current_j__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_j__n[__i], diff );
      sprintf( testName, "fast_sodium_current_h__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_h__n[__i], diff );
      sprintf( testName, "slow_inward_current_d__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_d__n[__i], diff );
      sprintf( testName, "time_dependent_potassium_current_X__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, time_dependent_potassium_current_X__n[__i], diff );
      sprintf( testName, "fast_sodium_current_m__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, fast_sodium_current_m__n[__i], diff );
      sprintf( testName, "slow_inward_current_f__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, slow_inward_current_f__n[__i], diff );
      sprintf( testName, "membrane_V__n_%d_%lf", __i, membrane_time) ;
      testCell( testName, membrane_V__n[__i], diff );
    }

    /* test */
    /* for(__i=0; __i<__MAX_DATA_NUM; __i++) { */
    /*   sprintf( testName, "V0end_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, V0end[__i], diff ); */
    /*   sprintf( testName, "V1end_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, V1end[__i], diff ); */
    /*   sprintf( testName, "X0end_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, X0end[__i], diff ); */
    /*   sprintf( testName, "X1end_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, X1end[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_E_Na__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_E_Na__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_h__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_h__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_h__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_h__n1[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_h_gate_alpha_h__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_h_gate_alpha_h__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_h_gate_beta_h__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_h_gate_beta_h__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_j__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_j__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_j__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_j__n1[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_j_gate_alpha_j__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_j_gate_alpha_j__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_j_gate_beta_j__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_j_gate_beta_j__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_m__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_m__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_m__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_m__n1[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_m_gate_alpha_m__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_m_gate_alpha_m__n[__i], diff ); */
    /*   sprintf( testName, "fast_sodium_current_m_gate_beta_m__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, fast_sodium_current_m_gate_beta_m__n[__i], diff ); */
    /*   sprintf( testName, "membrane_I_stim__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_I_stim__n[__i], diff ); */
    /*   sprintf( testName, "membrane_V__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_V__n[__i], diff ); */
    /*   sprintf( testName, "membrane_V__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_V__n1[__i], diff ); */
    /*   sprintf( testName, "membrane_i_K1__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_K1__n[__i], diff ); */
    /*   sprintf( testName, "membrane_i_K__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_K__n[__i], diff ); */
    /*   sprintf( testName, "membrane_i_Kp__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_Kp__n[__i], diff ); */
    /*   sprintf( testName, "membrane_i_Na__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_Na__n[__i], diff ); */
    /*   sprintf( testName, "membrane_i_b__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_b__n[__i], diff ); */
    /*   sprintf( testName, "membrane_i_si__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, membrane_i_si__n[__i], diff ); */
    /*   sprintf( testName, "plateau_potassium_current_E_Kp__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, plateau_potassium_current_E_Kp__n[__i], diff ); */
    /*   sprintf( testName, "plateau_potassium_current_Kp__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, plateau_potassium_current_Kp__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_Cai__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_Cai__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_Cai__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_Cai__n1[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_E_si__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_E_si__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_d__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_d__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_d__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_d__n1[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_d_gate_alpha_d__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_d_gate_alpha_d__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_d_gate_beta_d__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_d_gate_beta_d__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_f__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_f__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_f__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_f__n1[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_f_gate_alpha_f__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_f_gate_alpha_f__n[__i], diff ); */
    /*   sprintf( testName, "slow_inward_current_f_gate_beta_f__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, slow_inward_current_f_gate_beta_f__n[__i], diff ); */
    ...
    /*   sprintf( testName, "time_dependent_potassium_current_X__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_dependent_potassium_current_X__n[__i], diff ); */
    /*   sprintf( testName, "time_dependent_potassium_current_X__n1_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_dependent_potassium_current_X__n1[__i], diff ); */
    /*   sprintf( testName, "time_dependent_potassium_current_X_gate_alpha_X__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_dependent_potassium_current_X_gate_alpha_X__n[__i], diff ); */
    /*   sprintf( testName, "time_dependent_potassium_current_X_gate_beta_X__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_dependent_potassium_current_X_gate_beta_X__n[__i], diff ); */
    ...
    /*   sprintf( testName, "time_independent_potassium_current_E_K1__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_independent_potassium_current_E_K1__n[__i], diff ); */
    /*   sprintf( testName, "time_independent_potassium_current_K1_gate_alpha_K1__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_independent_potassium_current_K1_gate_alpha_K1__n[__i], diff ); */
    /*   sprintf( testName, "time_independent_potassium_current_K1_gate_beta_K1__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_independent_potassium_current_K1_gate_beta_K1__n[__i], diff ); */
    /*   sprintf( testName, "time_independent_potassium_current_K1_infinity__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_independent_potassium_current_K1_infinity__n[__i], diff ); */
    /*   sprintf( testName, "time_independent_potassium_current_g_K1__n_%d_%lf", __i, membrane_time) ; */
    /*   testCell( testName, time_independent_potassium_current_g_K1__n[__i], diff ); */
    /* } */
