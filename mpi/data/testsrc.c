	...
	if(rank == 0){
		...
		for(n = 0; ( n < 1000 ) ;n++){
			...
			for(__i = 0; ( __i < 500 ) ;__i++){
				...
				zz[n][__meshnum] =  (  (  ( n < (double)10 )  && __meshnum == (double)1 )  ? (double)1.0 : (double)0.0 ) ;
				r[n][__meshnum] =  ( v[n][__meshnum] * v[n][__meshnum] * v[n][__meshnum] ) ;
				v[ ( n + 1 ) ][__meshnum] =  ( v[n][__meshnum] +  (  (  (  (  ( v[n][__meshnum] -  ( r[n][__meshnum] / (double)3 )  )  - w[n][__meshnum] )  + zz[n][__meshnum] )  -  (  ( D *  (  ( v[n][xright[__meshnum]] + v[n][xleft[__meshnum]] )  -  ( (double)2 * v[n][__meshnum] )  )  )  /  ( dx * dx )  )  )  * dt )  ) ;
				w[ ( n + 1 ) ][__meshnum] =  ( w[n][__meshnum] +  ( e *  (  ( v[n][__meshnum] + b )  -  ( g * w[n][__meshnum] )  )  * dt )  ) ;
