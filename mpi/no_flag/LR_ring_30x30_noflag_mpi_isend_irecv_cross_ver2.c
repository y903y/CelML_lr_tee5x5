...
int main ( int argc , char** argv ) {
	...
	/*各ノードの通信(送受信)する配列のインデックス番号を保持*/
	/*送信用*/
	int sendindex01[8] = {  1,  11,  25,  42,  61,  82, 105, 129};
	int sendindex02[8] = {242, 243, 244, 245, 246, 247, 248, 249};
	int sendindex11[8] = {  2,  12,  26,  43,  62,  83, 106, 130};
	int sendindex12[8] = {250, 251, 252, 253, 254, 255, 256, 257};
	int sendindex21[8] = {385, 409, 432, 453, 472, 489, 503, 513};
	int sendindex22[8] = {258, 259, 260, 261, 262, 263, 264, 265};
	int sendindex31[8] = {386, 410, 433, 454, 473, 490, 504, 514};
	int sendindex32[8] = {266, 267, 268, 269, 270, 271, 272, 273};
	/*受信用*/
	int recvindex01[8] = {  2,  12,  26,  43,  62,  83, 106, 130};
	int recvindex02[8] = {258, 259, 260, 261, 262, 263, 264, 265};
	int recvindex11[8] = {  1,  11,  25,  42,  61,  82, 105, 129};
	int recvindex12[8] = {266, 267, 268, 269, 270, 271, 272, 273};
	int recvindex21[8] = {386, 410, 433, 454, 473, 490, 504, 514};
	int recvindex22[8] = {242, 243, 244, 245, 246, 247, 248, 249};
	int recvindex31[8] = {385, 409, 432, 453, 472, 489, 503, 513};
	int recvindex32[8] = {250, 251, 252, 253, 254, 255, 256, 257};
	...
	if(myrank == root){
		...
		for(membrane_time = 0.000000; ( membrane_time <= 500.000000 ) ;membrane_time =  ( membrane_time + deltat ) ){
			...
			for(__i = 0; __i < 8; __i++){
				...
				sendarray1[__i] = membrane_V__n[arrayindex];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex02[__i];
				sendarray2[__i] = membrane_V__n[arrayindex];
			}
			...
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				slow_inward_current_f_gate_beta_f__n[arrayindex] =  (  ( (double)0.0065 * exp(  (  ( - (double)0.02 )  *  ( membrane_V__n[arrayindex] + (double)30 )  )  ) )  /  ( (double)1 + exp(  (  ( - (double)0.2 )  *  ( membrane_V__n[arrayindex] + (double)30 )  )  ) )  ) ;
				plateau_potassium_current_Kp__n[arrayindex] =  ( (double)1 /  ( (double)1 + exp(  (  ( (double)7.488 - membrane_V__n[arrayindex] )  / (double)5.98 )  ) )  );
				slow_inward_current_f_gate_alpha_f__n[arrayindex] =  (  ( (double)0.012 * exp(  (  ( - (double)0.008 )  *  ( membrane_V__n[arrayindex] + (double)28 )  )  ) )  /  ( (double)1 + exp(  ( (double)0.15 *  ( membrane_V__n[arrayindex] + (double)28 )  )  ) )  ) ;
				slow_inward_current_d_gate_alpha_d__n[arrayindex] =  (  ( (double)0.095 * exp(  (  ( - (double)0.01 )  *  ( membrane_V__n[arrayindex] - (double)5 )  )  ) )  /  ( (double)1 + exp(  (  ( - (double)0.072 )  *  ( membrane_V__n[arrayindex] - (double)5 )  )  ) )  ) ;
				slow_inward_current_d_gate_beta_d__n[arrayindex] =  (  ( (double)0.07 * exp(  (  ( - (double)0.017 )  *  ( membrane_V__n[arrayindex] + (double)44 )  )  ) )  /  ( (double)1 + exp(  ( (double)0.05 *  ( membrane_V__n[arrayindex] + (double)44 )  )  ) )  ) ;
				slow_inward_current_E_si__n[arrayindex] =  ( (double)7.7 -  ( (double)13.0287 * log(  ( slow_inward_current_Cai__n[arrayindex] / (double)1 )  ) )  ) ;
				membrane_i_b__n[arrayindex] =  ( background_current_g_b *  ( membrane_V__n[arrayindex] - background_current_E_b )  ) ;
				fast_sodium_current_j_gate_beta_j__n[arrayindex] =  (  ( membrane_V__n[arrayindex] <  ( - (double)40 )  )  ?  (  ( (double)0.1212 * exp(  (  ( - (double)0.01052 )  * membrane_V__n[arrayindex] )  ) )  /  ( (double)1 + exp(  (  ( - (double)0.1378 )  *  ( membrane_V__n[arrayindex] + (double)40.14 )  )  ) )  )  :  (  ( (double)0.3 * exp(  (  ( - (double)0.0000002535 )  * membrane_V__n[arrayindex] )  ) )  /  ( (double)1 + exp(  (  ( - (double)0.1 )  *  ( membrane_V__n[arrayindex] + (double)32 )  )  ) )  )  ) ;
				time_dependent_potassium_current_g_K__n[arrayindex] =  ( time_dependent_potassium_current_g_Kbar * sqrt(  ( time_independent_potassium_current_Ko / (double)5.4 )  ) ) ;
				time_dependent_potassium_current_E_K__n[arrayindex] =  (  (  ( membrane_R * membrane_T )  / membrane_F )  * log(  (  ( time_independent_potassium_current_Ko +  ( time_dependent_potassium_current_PR_NaK * time_dependent_potassium_current_Nao )  )  /  ( time_independent_potassium_current_Ki +  ( time_dependent_potassium_current_PR_NaK * time_dependent_potassium_current_Nai )  )  )  ) ) ;
				time_dependent_potassium_current_X_gate_alpha_X__n[arrayindex] =  (  ( (double)0.0005 * exp(  ( (double)0.083 *  ( membrane_V__n[arrayindex] + (double)50 )  )  ) )  /  ( (double)1 + exp(  ( (double)0.057 *  ( membrane_V__n[arrayindex] + (double)50 )  )  ) )  ) ;
				time_dependent_potassium_current_X_gate_beta_X__n[arrayindex] =  (  ( (double)0.0013 * exp(  (  ( - (double)0.06 )  *  ( membrane_V__n[arrayindex] + (double)20 )  )  ) )  /  ( (double)1 + exp(  (  ( - (double)0.04 )  *  ( membrane_V__n[arrayindex] + (double)20 )  )  ) )  ) ;
				time_dependent_potassium_current_Xi__n[arrayindex] =  (  ( membrane_V__n[arrayindex] >  ( - (double)100 )  )  ?  (  ( (double)2.837 *  ( exp(  ( (double)0.04 *  ( membrane_V__n[arrayindex] + (double)77 )  )  ) - (double)1 )  )  /  (  ( membrane_V__n[arrayindex] + (double)77 )  * exp(  ( (double)0.04 *  ( membrane_V__n[arrayindex] + (double)35 )  )  ) )  )  : (double)1 ) ;
				time_independent_potassium_current_g_K1__n[arrayindex] =  ( (double)0.6047 * sqrt(  ( time_independent_potassium_current_Ko / (double)5.4 )  ) ) ;
				time_independent_potassium_current_E_K1__n[arrayindex] =  (  (  ( membrane_R * membrane_T )  / membrane_F )  * log(  ( time_independent_potassium_current_Ko / time_independent_potassium_current_Ki )  ) ) ;
				fast_sodium_current_E_Na__n[arrayindex] =  (  (  ( membrane_R * membrane_T )  / membrane_F )  * log(  ( time_dependent_potassium_current_Nao / time_dependent_potassium_current_Nai )  ) ) ;
				fast_sodium_current_j_gate_alpha_j__n[arrayindex] =  (  ( membrane_V__n[arrayindex] <  ( - (double)40 )  )  ?  (  (  (  (  ( - (double)127140 )  * exp(  ( (double)0.2444 * membrane_V__n[arrayindex] )  ) )  -  ( (double)0.00003474 * exp(  (  ( - (double)0.04391 )  * membrane_V__n[arrayindex] )  ) )  )  *  ( membrane_V__n[arrayindex] + (double)37.78 )  )  /  ( (double)1 + exp(  ( (double)0.311 *  ( membrane_V__n[arrayindex] + (double)79.23 )  )  ) )  )  : (double)0 ) ;
				fast_sodium_current_h_gate_alpha_h__n[arrayindex] =  (  ( membrane_V__n[arrayindex] <  ( - (double)40 )  )  ?  ( (double)0.135 * exp(  (  ( (double)80 + membrane_V__n[arrayindex] )  /  ( - (double)6.8 )  )  ) )  : (double)0 ) ;
				fast_sodium_current_m_gate_beta_m__n[arrayindex] =  ( (double)0.08 * exp(  (  ( - membrane_V__n[arrayindex] )  / (double)11 )  ) ) ;
				fast_sodium_current_m_gate_alpha_m__n[arrayindex] =  (  ( (double)0.32 *  ( membrane_V__n[arrayindex] + (double)47.13 )  )  /  ( (double)1 - exp(  (  ( - (double)0.1 )  *  ( membrane_V__n[arrayindex] + (double)47.13 )  )  ) )  ) ;
				fast_sodium_current_h_gate_beta_h__n[arrayindex] =  (  ( membrane_V__n[arrayindex] <  ( - (double)40 )  )  ?  (  ( (double)3.56 * exp(  ( (double)0.079 * membrane_V__n[arrayindex] )  ) )  +  ( (double)310000 * exp(  ( (double)0.35 * membrane_V__n[arrayindex] )  ) )  )  :  ( (double)1 /  ( (double)0.13 *  ( (double)1 + exp(  (  ( membrane_V__n[arrayindex] + (double)10.66 )  /  ( - (double)11.1 )  )  ) )  )  )  ) ;
			}
			//con2 = MPI_Wtime();
			...
			/*通信配列のアンパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex01[__i];
				membrane_V__n[arrayindex] = recvarray1[__i];
			}
			for(__i = 0; __i < 8; __i++){
			...
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				slow_inward_current_d__n1[arrayindex] =  ( slow_inward_current_d__n[arrayindex] + deltat * (  ( slow_inward_current_d_gate_alpha_d__n[arrayindex] *  ( (double)1 - slow_inward_current_d__n[arrayindex] )  )  -  ( slow_inward_current_d_gate_beta_d__n[arrayindex] * slow_inward_current_d__n[arrayindex] )  ) ) ;
				fast_sodium_current_j__n1[arrayindex] =  ( fast_sodium_current_j__n[arrayindex] + deltat * (  ( fast_sodium_current_j_gate_alpha_j__n[arrayindex] *  ( (double)1 - fast_sodium_current_j__n[arrayindex] )  )  -  ( fast_sodium_current_j_gate_beta_j__n[arrayindex] * fast_sodium_current_j__n[arrayindex] )  ) ) ;
				slow_inward_current_f__n1[arrayindex] =  ( slow_inward_current_f__n[arrayindex] + deltat * (  ( slow_inward_current_f_gate_alpha_f__n[arrayindex] *  ( (double)1 - slow_inward_current_f__n[arrayindex] )  )  -  ( slow_inward_current_f_gate_beta_f__n[arrayindex] * slow_inward_current_f__n[arrayindex] )  ) ) ;
				time_dependent_potassium_current_X__n1[arrayindex] =  ( time_dependent_potassium_current_X__n[arrayindex] + deltat * (  ( time_dependent_potassium_current_X_gate_alpha_X__n[arrayindex] *  ( (double)1 - time_dependent_potassium_current_X__n[arrayindex] )  )  -  ( time_dependent_potassium_current_X_gate_beta_X__n[arrayindex] * time_dependent_potassium_current_X__n[arrayindex] )  ) ) ;
				fast_sodium_current_m__n1[arrayindex] =  ( fast_sodium_current_m__n[arrayindex] + deltat * (  ( fast_sodium_current_m_gate_alpha_m__n[arrayindex] *  ( (double)1 - fast_sodium_current_m__n[arrayindex] )  )  -  ( fast_sodium_current_m_gate_beta_m__n[arrayindex] * fast_sodium_current_m__n[arrayindex] )  ) ) ;
				fast_sodium_current_h__n1[arrayindex] =  ( fast_sodium_current_h__n[arrayindex] + deltat * (  ( fast_sodium_current_h_gate_alpha_h__n[arrayindex] *  ( (double)1 - fast_sodium_current_h__n[arrayindex] )  )  -  ( fast_sodium_current_h_gate_beta_h__n[arrayindex] * fast_sodium_current_h__n[arrayindex] )  ) ) ;
				membrane_i_si__n[arrayindex] =  ( (double)0.09 * slow_inward_current_d__n[arrayindex] * slow_inward_current_f__n[arrayindex] *  ( membrane_V__n[arrayindex] - slow_inward_current_E_si__n[arrayindex] )  ) ;
				membrane_i_K__n[arrayindex] =  ( time_dependent_potassium_current_g_K__n[arrayindex] * time_dependent_potassium_current_X__n[arrayindex] * time_dependent_potassium_current_Xi__n[arrayindex] *  ( membrane_V__n[arrayindex] - time_dependent_potassium_current_E_K__n[arrayindex] )  ) ;
				time_independent_potassium_current_K1_gate_beta_K1__n[arrayindex] =  (  (  ( (double)0.49124 * exp(  ( (double)0.08032 *  (  ( membrane_V__n[arrayindex] + (double)5.476 )  - time_independent_potassium_current_E_K1__n[arrayindex] )  )  ) )  +  ( (double)1 * exp(  ( (double)0.06175 *  ( membrane_V__n[arrayindex] -  ( time_independent_potassium_current_E_K1__n[arrayindex] + (double)594.31 )  )  )  ) )  )  /  ( (double)1 + exp(  (  ( - (double)0.5143 )  *  (  ( membrane_V__n[arrayindex] - time_independent_potassium_current_E_K1__n[arrayindex] )  + (double)4.753 )  )  ) )  ) ;
				plateau_potassium_current_E_Kp__n[arrayindex] =  time_independent_potassium_current_E_K1__n[arrayindex] ;
				time_independent_potassium_current_K1_gate_alpha_K1__n[arrayindex] =  ( (double)1.02 /  ( (double)1 + exp(  ( (double)0.2385 *  (  ( membrane_V__n[arrayindex] - time_independent_potassium_current_E_K1__n[arrayindex] )  - (double)59.215 )  )  ) )  ) ;
				membrane_i_Na__n[arrayindex] =  ( fast_sodium_current_g_Na * pow( fast_sodium_current_m__n[arrayindex] , (double)3 ) * fast_sodium_current_h__n[arrayindex] * fast_sodium_current_j__n[arrayindex] *  ( membrane_V__n[arrayindex] - fast_sodium_current_E_Na__n[arrayindex] )  ) ;
				...
				if (arrayindex>=0 && arrayindex<=5) {
					membrane_I_stim__n[arrayindex] =  (  (  ( membrane_time >= membrane_stim_start )  &&  ( membrane_time <= membrane_stim_end )  &&  (  (  ( membrane_time - membrane_stim_start )  -  ( floor(  (  ( membrane_time - membrane_stim_start )  / membrane_stim_period )  ) * membrane_stim_period )  )  <= membrane_stim_duration )  )  ? membrane_stim_amplitude : (double)0 ) ;
				} else {
					membrane_I_stim__n[arrayindex] =  0 ;
				}
			}
			...
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				slow_inward_current_Cai__n1[arrayindex] = ( slow_inward_current_Cai__n[arrayindex] + deltat * (  (  (  ( - (double)0.0001 )  / (double)1 )  * membrane_i_si__n[arrayindex] )  +  ( (double)0.07 *  ( (double)0.0001 - slow_inward_current_Cai__n[arrayindex] )  )  ) ) ;
				membrane_i_Kp__n[arrayindex] =  ( plateau_potassium_current_g_Kp * plateau_potassium_current_Kp__n[arrayindex] *  ( membrane_V__n[arrayindex] - plateau_potassium_current_E_Kp__n[arrayindex] )  ) ;
				time_independent_potassium_current_K1_infinity__n[arrayindex] =  ( time_independent_potassium_current_K1_gate_alpha_K1__n[arrayindex] /  ( time_independent_potassium_current_K1_gate_alpha_K1__n[arrayindex] + time_independent_potassium_current_K1_gate_beta_K1__n[arrayindex] )  ) ;
			}

			//Shortest Calculation Order:3
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				membrane_i_K1__n[arrayindex] =  ( time_independent_potassium_current_g_K1__n[arrayindex] * time_independent_potassium_current_K1_infinity__n[arrayindex] *  ( membrane_V__n[arrayindex] - time_independent_potassium_current_E_K1__n[arrayindex] )  ) ;
			}
			...
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				membrane_V__n1[arrayindex]  =  ( membrane_V__n[arrayindex] + deltat * ( (  (  ( - (double)1 )  / membrane_C )  *  ( membrane_I_stim__n[arrayindex] + membrane_i_Na__n[arrayindex] + membrane_i_si__n[arrayindex] + membrane_i_K__n[arrayindex] + membrane_i_K1__n[arrayindex] + membrane_i_Kp__n[arrayindex] + membrane_i_b__n[arrayindex] )  )  +  ( membrane_D *  (  ( membrane_V__n[ ( R[arrayindex] ) ] +  ( -  ( (double)2 * membrane_V__n[arrayindex] )  )  + membrane_V__n[ ( L[arrayindex] ) ] )  /  ( deltax1 * deltax1 )  )  )  +  ( membrane_D *  (  ( membrane_V__n[ ( D[arrayindex] )] +  ( -  ( (double)2 * membrane_V__n[arrayindex] )  )  + membrane_V__n[ ( U[arrayindex] ) ] )  /  ( deltax2 * deltax2 )  )  )  ) ) ;
			}
			...
			for(__i = 0; __i < calcindex ; __i++){
				arrayindex = nodeindex0[__i];
				fast_sodium_current_j__n[arrayindex] = fast_sodium_current_j__n1[arrayindex];
				fast_sodium_current_h__n[arrayindex] = fast_sodium_current_h__n1[arrayindex];
				slow_inward_current_d__n[arrayindex] = slow_inward_current_d__n1[arrayindex];
				time_dependent_potassium_current_X__n[arrayindex] = time_dependent_potassium_current_X__n1[arrayindex];
				fast_sodium_current_m__n[arrayindex] = fast_sodium_current_m__n1[arrayindex];
		...
		for(membrane_time = 0.000000; ( membrane_time <= 500.000000 ) ;membrane_time =  ( membrane_time + deltat ) ){
			...
			/*送信配列のパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex11[__i];
				sendarray1[__i] = membrane_V__n[arrayindex];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex12[__i];
				sendarray2[__i] = membrane_V__n[arrayindex];
			}
			...
			/*通信配列のアンパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex11[__i];
				membrane_V__n[arrayindex] = recvarray1[__i];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex12[__i];
				membrane_V__n[arrayindex] = recvarray2[__i];
			}
		...
		for(membrane_time = 0.000000; ( membrane_time <= 500.000000 ) ;membrane_time =  ( membrane_time + deltat ) ){
			...
			/*送信配列のパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex21[__i];
				sendarray1[__i] = membrane_V__n[arrayindex];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex22[__i];
				sendarray2[__i] = membrane_V__n[arrayindex];
			}
			...
			/*通信配列のアンパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex21[__i];
				membrane_V__n[arrayindex] = recvarray1[__i];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex22[__i];
				membrane_V__n[arrayindex] = recvarray2[__i];
			}
		...
		for(membrane_time = 0.000000; ( membrane_time <= 500.000000 ) ;membrane_time =  ( membrane_time + deltat ) ){
			...
			/*送信配列のパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex31[__i];
				sendarray1[__i] = membrane_V__n[arrayindex];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = sendindex32[__i];
				sendarray2[__i] = membrane_V__n[arrayindex];
			}
			...
			/*通信配列のアンパック*/
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex31[__i];
				membrane_V__n[arrayindex] = recvarray1[__i];
			}
			for(__i = 0; __i < 8; __i++){
				arrayindex = recvindex32[__i];
				membrane_V__n[arrayindex] = recvarray2[__i];
			}
