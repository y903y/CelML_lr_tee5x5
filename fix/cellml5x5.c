...
//			i = (double)100;
		...
		/*if(logcount == 1){
			...
			for(__i=6; __i<=17; __i++){
				printf("membrane_V__n[%d]:%f\n", __i, membrane_V__n[__i]);
				printf("membrane_I_stim__n[%d]:%f\n", __i, membrane_I_stim__n[__i]);
				printf("membrane_i_Na__n[%d]:%f\n", __i, membrane_i_Na__n[__i]);
				printf("membrane_i_si__n[%d]:%f\n", __i, membrane_i_si__n[__i]);
				printf("membrane_i_K__n[%d]:%f\n", __i, membrane_i_K__n[__i]);
				printf("membrane_i_K1__n[%d]:%f\n", __i, membrane_i_K1__n[__i]);
				printf("membrane_i_Kp__n[%d]:%f\n", __i, membrane_i_Kp__n[__i]);
				printf("membrane_i_b__n[%d]:%f\n", __i, membrane_i_b__n[__i]);
				printf("membrane_V__n[%d]:%f\n", __i, membrane_V__n[__i]);
				printf("membrane_V__n[%d]:%f\n", __i, membrane_V__n[__i]);
				printf("membrane_V__n[%d]:%f\n", __i, membrane_V__n[__i]);
				printf("membrane_V__n[%d]:%f\n", __i, membrane_V__n[__i]);
