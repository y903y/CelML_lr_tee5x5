...
int main ( int argc , char** argv ) {
 ...
 double membrane_D = 0.1;
 double membrane_R = 8314.0;
 double membrane_T = 310.0;
 double membrane_F = 96484.6;
 double membrane_C = 1.0;
 double membrane_stim_start = 100.0;
 double membrane_stim_end = 1000000000000.0;
 double membrane_stim_period = 1000.0;
 double membrane_stim_duration = 2.0;
 double membrane_stim_amplitude = -25.5;
 double fast_sodium_current_g_Na = 23.0;
 double background_current_g_b = 0.03921;
 double time_dependent_potassium_current_g_Kbar = 0.282;
 double time_dependent_potassium_current_Nai = 18.0;
 double time_dependent_potassium_current_Nao = 140.0;
 double plateau_potassium_current_g_Kp = 0.0183;
 double background_current_E_b = -59.87;
 double time_independent_potassium_current_Ki = 145.0;
 double time_independent_potassium_current_Ko = 5.4;
 ...
 /* REVISION: removed membrane_time, n and i malloc */
 ...
 for (i = 0; i < 12; i++) {
   __flag2__n[i] = __flag36__n[i] = __flag49__n[i] = __flag52__n[i] = __flag53__n[i] = 1;
 }
 for (i = 0; i < 25; i++) {
   slow_inward_current_Cai__n[i] = 0.002;
   time_independent_potassium_current_K1_gate_beta_K1__n[i] = 1.0;
 }
 __flag2__n[9-6] = 0;
 __flag2__n[10-6] = 0;
 __flag2__n[11-6] = 0;
 ...
 for(membrane_time = 0.000000; ( membrane_time <= 1000.000000 ) ;membrane_time =  ( membrane_time + deltat ) ){
...
//   i = (double)100;
  ...
  for(__i=6; __i<=17; __i++){
   ...
   /*
   printf("%d: ", __i);
   printf("%lf ", slow_inward_current_f_gate_beta_f__n[__i]);
   printf("%lf ", plateau_potassium_current_Kp__n[__i]);
   printf("%lf ", slow_inward_current_f_gate_alpha_f__n[__i]);
   printf("%lf ", slow_inward_current_d_gate_alpha_d__n[__i]);
   printf("%lf ", slow_inward_current_d_gate_beta_d__n[__i]);
   printf("%lf ", slow_inward_current_E_si__n[__i]);
   printf("%lf ", membrane_i_b__n[__i]);
   printf("%lf ", fast_sodium_current_j_gate_beta_j__n[__i]);
   printf("%lf ", time_dependent_potassium_current_g_K__n[__i]);
   printf("%lf ", time_dependent_potassium_current_E_K__n[__i]);
   printf("%lf ", time_dependent_potassium_current_X_gate_alpha_X__n[__i]);
   printf("%lf ", time_dependent_potassium_current_X_gate_beta_X__n[__i]);
   printf("%lf ", time_dependent_potassium_current_Xi__n[__i]);
   printf("%lf ", time_independent_potassium_current_g_K1__n[__i]);
   //
   printf("%lf ", time_independent_potassium_current_E_K1__n[__i]);
   //
   printf("%lf ", fast_sodium_current_E_Na__n[__i]);
   printf("%lf ", fast_sodium_current_j_gate_alpha_j__n[__i]);
   printf("%lf ", fast_sodium_current_h_gate_alpha_h__n[__i]);
   printf("%lf ", fast_sodium_current_m_gate_beta_m__n[__i]);
   printf("%lf ", fast_sodium_current_m_gate_alpha_m__n[__i]);
   printf("%lf ", fast_sodium_current_h_gate_beta_h__n[__i]);
   printf("\n");
   */
  }
  //----------------------------- LOOP END -----------------------------//
  ...
  //---------------------------- LOOP ----------------------------//
  for(__i=6; __i<=17; __i++){
   slow_inward_current_d__n1[__i] =  ( ( slow_inward_current_d__n[__i] + deltat * (  ( slow_inward_current_d_gate_alpha_d__n[__i] *  ( (double)1 - slow_inward_current_d__n[__i] )  )  -  ( slow_inward_current_d_gate_beta_d__n[__i] * slow_inward_current_d__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  + ( slow_inward_current_d__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   fast_sodium_current_j__n1[__i] =  ( ( fast_sodium_current_j__n[__i] + deltat * (  ( fast_sodium_current_j_gate_alpha_j__n[__i] *  ( (double)1 - fast_sodium_current_j__n[__i] )  )  -  ( fast_sodium_current_j_gate_beta_j__n[__i] * fast_sodium_current_j__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  + ( fast_sodium_current_j__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   slow_inward_current_f__n1[__i] =  ( ( slow_inward_current_f__n[__i] + deltat * (  ( slow_inward_current_f_gate_alpha_f__n[__i] *  ( (double)1 - slow_inward_current_f__n[__i] )  )  -  ( slow_inward_current_f_gate_beta_f__n[__i] * slow_inward_current_f__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  + ( slow_inward_current_f__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   time_dependent_potassium_current_X__n1[__i] =  ( ( time_dependent_potassium_current_X__n[__i] + deltat * (  ( time_dependent_potassium_current_X_gate_alpha_X__n[__i] *  ( (double)1 - time_dependent_potassium_current_X__n[__i] )  )  -  ( time_dependent_potassium_current_X_gate_beta_X__n[__i] * time_dependent_potassium_current_X__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  +  ( time_dependent_potassium_current_X__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   fast_sodium_current_m__n1[__i] =  ( ( fast_sodium_current_m__n[__i] + deltat * (  ( fast_sodium_current_m_gate_alpha_m__n[__i] *  ( (double)1 - fast_sodium_current_m__n[__i] )  )  -  ( fast_sodium_current_m_gate_beta_m__n[__i] * fast_sodium_current_m__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  + ( fast_sodium_current_m__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   fast_sodium_current_h__n1[__i] =  ( ( fast_sodium_current_h__n[__i] + deltat * (  ( fast_sodium_current_h_gate_alpha_h__n[__i] *  ( (double)1 - fast_sodium_current_h__n[__i] )  )  -  ( fast_sodium_current_h_gate_beta_h__n[__i] * fast_sodium_current_h__n[__i] )  ) ) * __flag36__n[ ( __i - 6 ) ] )  + ( fast_sodium_current_h__n1[__i] * ( 1 - __flag36__n[ ( __i - 6 ) ] ) ) ;
   ...
   /*
   printf("%d: ", __i);
   printf("%lf ", slow_inward_current_d__n1[__i]);
   printf("%lf ", fast_sodium_current_j__n1[__i]);
   printf("%lf ", slow_inward_current_f__n1[__i]);
   printf("%lf ", time_dependent_potassium_current_X__n1[__i]);
   printf("%lf ", fast_sodium_current_m__n1[__i]);
   printf("%lf ", fast_sodium_current_h__n1[__i]);
   printf("%lf ", membrane_i_si__n[__i]);
   printf("%lf ", membrane_i_K__n[__i]);
   printf("%lf ", time_independent_potassium_current_K1_gate_beta_K1__n[__i]);
   printf("%lf ", plateau_potassium_current_E_Kp__n[__i]);
   printf("%lf ", time_independent_potassium_current_K1_gate_alpha_K1__n[__i]);
   printf("%lf ", membrane_i_Na__n[__i]);
   printf("%lf ", membrane_I_stim__n[__i]);
   printf("\n");
   */
  }
  //----------------------------- LOOP END -----------------------------//
  ...
  //---------------------------- LOOP ----------------------------//
  for(__i=6; __i<=17; __i++){
   slow_inward_current_Cai__n1[__i] = ( ( slow_inward_current_Cai__n[__i] + deltat * (  (  (  ( - (double)0.0001 )  / (double)1 )  * membrane_i_si__n[__i] )  +  ( (double)0.07 *  ( (double)0.0001 - slow_inward_current_Cai__n[__i] )  )  ) ) * __flag49__n[ ( __i - 6 ) ] ) + ( slow_inward_current_Cai__n1[__i] * ( 1 - __flag49__n[ ( __i - 6 ) ] ) );
   ...
   /*
   printf("%d: ", __i);
   printf("%lf ", slow_inward_current_Cai__n1[__i]);
   printf("%lf ", membrane_i_Kp__n[__i]);
   printf("%lf ", time_independent_potassium_current_K1_infinity__n[__i]);
   printf("\n");
   */
  }
  //----------------------------- LOOP END -----------------------------//
  ...
  //---------------------------- LOOP ----------------------------//
  for(__i=6; __i<=17; __i++){
   membrane_V__n1[__i]  =  (  (  ( membrane_V__n[__i] + deltat * ( (  (  ( - (double)1 )  / membrane_C )  *  ( membrane_I_stim__n[__i] + membrane_i_Na__n[__i] + membrane_i_si__n[__i] + membrane_i_K__n[__i] + membrane_i_K1__n[__i] + membrane_i_Kp__n[__i] + membrane_i_b__n[__i] )  )  +  ( membrane_D *  (  ( membrane_V__n[ ( __i + 1 ) ] +  ( -  ( (double)2 * membrane_V__n[__i] )  )  + membrane_V__n[__i-1] )  /  ( deltax1 * deltax1 )  )  )  +  ( membrane_D *  (  ( membrane_V__n[__i+5] +  ( -  ( (double)2 * membrane_V__n[__i] )  )  + membrane_V__n[__i-5] )  /  ( deltax2 * deltax2 )  )  )  ) ) * __flag53__n[ ( __i - 6 ) ] )  +  (  membrane_V__n1[__i]  *  ( 1 - __flag53__n[ ( __i - 6 ) ] )  )  ) ;
  ...
  printf("%lf ", membrane_i_Kp__n[__i]);
  printf("%lf ", time_independent_potassium_current_K1_infinity__n[__i]);
  printf("%lf ", membrane_i_K1__n[__i]);
  printf("%lf ", membrane_V__n1[__i]);
  printf("\n");
  */
